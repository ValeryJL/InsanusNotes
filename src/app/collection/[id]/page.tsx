...
const tableCellClass = "border border-zinc-200 px-3 py-2 text-sm";
...
export default function CollectionPage() {
  ...
  return (
    <div className="min-h-screen bg-white px-10 py-12 text-zinc-900">
      ...
      {statusMessage ? (
        <p className="mt-6 text-sm text-zinc-400">{statusMessage}</p>
      ) : null}

      <div className="mt-6 overflow-auto rounded-lg border border-zinc-200">
        <table className="min-w-full border-collapse text-left">
          <thead className="bg-zinc-50">
            <tr>
              <th className={tableCellClass}>Titulo</th>
              {schema.map((definition) => (
                <th key={definition.id} className={tableCellClass}>
                  {definition.name}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            {notes.map((note) => {
              ...
              return (
                <tr key={note.id} className="odd:bg-white even:bg-zinc-50/40">
